...
insert into `quiz`(`quiz_id`,`quiz_title`,`quiz_background`,`created_by`,`is_public`,`feedback`) values (1, 'Collaborative Learning', 'Collaborative learning is the educational approach of using groups to enhance learning through working together. Groups of two or more learners work together to solve problems, complete tasks, or learn new concepts.\nTake this quiz now to find out how well you do in collaborative learning!', 1, true, '[{"1-10":"feedback1"},{"11-20":"feedback2"},{"21-30":"feedback3"}]');
insert into `quiz`(`quiz_id`,`quiz_title`,`quiz_background`,`created_by`,`is_public`,`feedback`) values (2, 'Collaborative Learning 2', 'Collaborative learning is the educational approach of using groups to enhance learning through working together. Groups of two or more learners work together to solve problems, complete tasks, or learn new concepts.\nTake this quiz now to find out how well you do in collaborative learning!', 1, true, '[{"1-10":"feedback1"},{"11-20":"feedback2"},{"21-30":"feedback3"}]');
